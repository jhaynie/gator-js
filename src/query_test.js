...
/*
   select count(a.id) as total,
      avg(datediff(now(), from_unixtime(a.created_at/1000))) as daysOpen,
      c.name as priority,
      d.name as status
      from issue a, jira_issue b, jira_issue_priority c, jira_project_status d
      where a.ref_id = b.id
      and a.ref_type = ?
      and b.priority_id = c.id
